...
RUN apt-get update \
    && apt-get -y --no-install-recommends install build-essential curl ca-certificates python3 python-is-python3 python3-pip autoconf autotools-dev automake libtool meson ninja-build \
